...
export function InsightsErrorState({ message, onRetry }: InsightsErrorStateProps) {
  return (
    <section className="rounded-3xl border border-red-200 bg-red-50 p-5 shadow-sm dark:border-red-900/60 dark:bg-red-950/30">
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-3">
          <div>
            <h2 className="text-sm font-semibold text-red-700 dark:text-red-300">Unable to load AI insights</h2>
